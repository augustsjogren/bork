...
- Use `bork issue start "Title" --prompt "Details..."` to spin off a new issue with its own worktree and agent
...
bork issue start "Subtask" --prompt "Implement this in a separate worktree"
